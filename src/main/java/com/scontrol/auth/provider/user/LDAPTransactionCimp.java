 ...
 */
public class LDAPTransactionCimp extends AbstractKeycloakTransaction {

    public static final Logger logger = Logger.getLogger(LDAPTransactionCimp.class);
    ...
    public LDAPTransactionCimp(LDAPStorageProviderCimp ldapProvider, LDAPObject ldapUser) {
