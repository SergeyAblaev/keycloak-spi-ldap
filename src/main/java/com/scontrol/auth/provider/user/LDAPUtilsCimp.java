 ...
 */
public class LDAPUtilsCimp {

    private static final Logger log = Logger.getLogger(LDAPUtilsCimp.class);
    ...
    public static LDAPObject addUserToLDAP(LDAPStorageProvider ldapProvider, RealmModel realm, UserModel user, Consumer<LDAPObject> consumerOnCreated) {
        ...
        ldapUser.executeOnMandatoryAttributesComplete(mandatoryAttrs, ldapObject -> {
            LDAPUtilsCimp.computeAndSetDn(ldapConfig, ldapObject);
    ...
    public static LDAPQueryCimp createQueryForUserSearch(LDAPStorageProviderCimp ldapProvider, RealmModel realm) {
        LDAPQueryCimp ldapQuery = new LDAPQueryCimp(ldapProvider);
...
//        }
    ...
    public static Set<String> getExistingMemberships(LDAPStorageProvider ldapProvider, String memberAttrName, LDAPObject ldapRole) {
        LDAPUtilsCimp.fillRangedAttribute(ldapProvider, ldapRole, memberAttrName);
